...
object MediaPlayerUtil {
    ...
    // MediaPlayerCallBack: lắng nghe và xử lý các sự kiện liên quan đến trình phát nhac
    ...
    fun releaseAll(){
        if(mediaPlayer.isPlaying) mediaPlayer.stop()
        mediaPlayer.release() //giải phóng tài nguyên và dung hoạt động
    }
}